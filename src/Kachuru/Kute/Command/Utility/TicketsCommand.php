...
class TicketsCommand extends Command
{
    ...
    {
        $this
            ->setName('utility:tickets')
            ->setAliases(['tickets'])
            ->setDescription('Pipe in the output of a git log command to show a list of JIRA ticket numbers')
            ->addOption('separator', 's', InputOption::VALUE_OPTIONAL, 'Provide the list of tickets separated by this', PHP_EOL)
            ->addOption('detailed', 'd', InputOption::VALUE_NONE, 'Show a detailed list of commits');
    }

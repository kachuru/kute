...
let g:pdv_cfg_Author = "Rupert Jones <rupert@sessiondigital.com>"
let g:pdv_cfg_Copyright = "Copyright (c) 2015 SessionDigital. (http://www.sessiondigital.com)"
...
let g:pdv_re_array  = "^arr*"
let g:pdv_re_float  = "^flo*"
let g:pdv_re_int    = "^int*"
let g:pdv_re_string = "^str*"
let g:pdv_re_bool = "^bol*"
...
func! PhpDocFunc()
	...
	while (l:parameters != ",") && (l:parameters != "")
        ...
        if l:paramtype == ""
            let l:paramtype = PhpDocType(l:paramname)
        endif
...
func! PhpDocVar()
    ...
    let l:type = PhpDocType(l:varname)
...
func! PhpDocClass()
	...
	if l:abstract != ""
        exe l:txtBOL . g:pdv_cfg_Commentncate . "@abstract" . g:pdv_cfg_EOL
    endif
	if l:final != ""
